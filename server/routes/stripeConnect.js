...
router.get('/goToLinkAuthorizeConnect', function(req, res, next) {
  let url = 'https://connect.stripe.com/oauth/authorize?response_type=code&client_id=' + config.stripe.connect.client_id + '&scope=read_only&redirect_uri=https://' + req.headers.host + '/%23/companie/mine'
